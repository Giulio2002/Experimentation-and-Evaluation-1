...
public class Main {
    ...
    private static <T extends Comparable<T>> void benchmarkSort(RandomizerCreator<T> r, int size, Random random) {
        ...
        // First let it do work on less runs, size should be the same however, behaviour should be the same just unnacounted
